package com.iridiscense.unitoperations.plotter.renderer.mypie;
...
import com.iridiscense.unitoperations.plotter.animation.ChartAnimator;
import com.iridiscense.unitoperations.plotter.charts.LineChart;
import com.iridiscense.unitoperations.plotter.charts.PieChart;
import com.iridiscense.unitoperations.plotter.data.Entry;
import com.iridiscense.unitoperations.plotter.data.PieData;
import com.iridiscense.unitoperations.plotter.data.PieEntry;
...
import com.iridiscense.unitoperations.plotter.interfaces.datasets.IPieDataSet;
import com.iridiscense.unitoperations.plotter.renderer.DataRenderer;
import com.iridiscense.unitoperations.plotter.utils.ColorTemplate;
 ...
 * Created by bon on 12/2/21.
 * Copyright (c)  Hector Bonifacio. 12/2/21, All rights reserved.
 */
public class MyChartRenderer extends DataRenderer {
    ...
    public MyChartRenderer(PieChart chart, ChartAnimator animator,
    ...
    public void drawValues(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            //entryCount = 4 (para ambas etiquetas del char, el que va junto a la torta y la negras exteriores)
            for (int j = 0; j < entryCount; j++) {
                ...
                //Este es que se encarga de de las itiquetas negras?
                if (drawXOutside || drawYOutside) {
                    ...
                    //Esta parte del código imprime los valoresx de la torta
                    // draw everything, depending on settings
                    if (drawXOutside && drawYOutside) {

                        //Aunn desactivando esta seccion, la torta imprime el valor en la pantalla
                        drawValue(c,
                                formatter,
                                value,
                                entry,
                        ...
                        // Esta es la seccion que se encarga de imprimir los valores de las lineas de la torta
                ...
                xIndex++;   //cantidad de lineas que muestran los valores de cada porcion de la torta
            }
